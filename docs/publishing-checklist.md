...
| **`date-released` in `CITATION.cff`** | `2026-08-17` | Added when the actual `v0.1.0` GitHub Release was published — see `CHANGELOG.md`, `[0.1.0] - 2026-08-17`. |
| **Screenshots** (`docs/images/`) | Captured | Three screenshots of the live hosted sandbox (Guided Mode, a verification result, Advanced Mode) — see `README.md`, "See MEVA in action". |
